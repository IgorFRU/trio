...
<body>
    ...
    <header>
        <div class="menu">
            ...
            <div class="fastmenu">
                    <div class="fastmenu__body d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <div class="col-6 col-sm-6 col-md-3 px-4">
                        ...
                        <div class="col-6 col-sm-6 col-md-3 px-4">
                            <ul class="fastmenu__body__tel">                                
                                ...
                                @endif
                                <li><a href="tel:+79788808206">+7 (978) 880 82 06</a></li>
                            </ul>
                        </div>
                    </div>
