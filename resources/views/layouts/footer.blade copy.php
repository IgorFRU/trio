<footer>
    <div class="container">
        <div class="footer_content row">
            {{-- <div class="col-12 col-sm-6 col-lg-3   footer_content__about">
            ...
            <div class="col-12 col-sm-6 col-lg-3  footer_content__contacts">
                <div class="footer_content__title">
                    Контакты
                </div>
                <div>
                    <span class="col-12 col-sm-6 col-lg-3  __phone"><a href="tel:+79788160166">8(978) 816 01 66</a></span>
                    <p>Республика Крым</p>
                    <p>г. Симферополь</p>
                    <p>проспект Победы, 129/2</p>
                </div>
            </div>
            <div class="col-12 col-sm-6 col-lg-3   footer_content__items">
                <div class="footer_content__title">
                    Популярные категрии
                </div>
                <div>
            ...
            {{-- <div class="col-12 col-sm-6 col-lg-3   footer_content__socials">
                <div class="footer_content__title">
                    Мы в соцсетях
                </div>
            </div> --}}
