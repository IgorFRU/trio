                ...
                <div class="uk-grid uk-child-width-1-2@m uk-child-width-1-3@l uk-text-center uk-padding" uk-grid>
                    @forelse ($categories as $category)
                            <div class="uk-card uk-card-default uk-card-body">
                                <h3 class="uk-card-title"><a href="{{ route('admin.deliverycategories.show', ['category_id' => $category->id]) }}">{{ $category->deliverycategory ?? '' }}</a> <span class="uk-label uk-label-success">{{ $category->deliveries->count() }}</span></h3>
