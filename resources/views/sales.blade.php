                                ...
                                @foreach ($sales as $sale)
                                    <div class="uk-width-1-3@m uk-padding-small">
                                        <div class="uk-card uk-card-default uk-card-body ">
                                            ...
                                            <hr>
                                            <div class="card_info card_info_sale_date @if($sale->it_actuality) uk-text-success uk-text-bold @else uk-text-danger  @endif">{{ $sale->start_d_m_y }} - {{ $sale->d_m_y }}@if(!$sale->it_actuality)<br><span class="bold">(акция закончилась!)</span> @endif</div>
